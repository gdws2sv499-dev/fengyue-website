...
const translations = {
  ...
  about_h1_a:        { zh: '为极限而生', en: 'Built for the Extreme' },
  about_h1_b:        { zh: '为你而造',  en: 'Made for You' },
  about_desc:        { zh: '2004年创立于江苏，二十年来专注专业睡袋的研发与制造。我们相信，每一次野外的夜晚，都值得拥有最可靠的温暖。',
                       en: 'Founded in Jiangsu in 2004, twenty years dedicated to professional sleeping bag R&D and manufacturing. We believe every night in the wild deserves the most reliable warmth.' },
  ...
  brand_p1:          { zh: '2004年，峰悦的创始人带着对户外运动的热爱和对品质的执着，在江苏创立了这家专注睡袋制造的企业。',
                       en: 'In 2004, FENGYUE\'s founder, driven by a passion for outdoor sports and a commitment to quality, established this sleeping bag manufacturing company in Jiangsu.' },
